...
const mergeList = defineModel('mergeList',{ type: Array, default: () => [] });
const delimiter = defineModel('delimiter',{ type: String, default: () => "" });
        ...
        <div class="modal-content shadow-lg">
          ...
          <div class="modal-body p-4">
              ...
              <div class="d-flex flex-column gap-2">
                ...
                >
                  ...
                  <span class="flex-grow-1 fw-bold">
                    ...
                    <small class="text-muted">({{ getColumnDetails(colIdx).index }})</small>
                  </span>
            ...
            <div class="row g-2">
              ...
              <div class="col-9">
                <input type="text" v-model="delimiter" class="form-control" placeholder="Delimiter (optional)">
              </div>
              <div class="col-3">
                <button class="btn w-100 border-0" :disabled="true">Delimiter</button>
              </div>
